...
<div class="easyui-panel" title="" style="width:99%; height:auto;" data-options="border:false">
   <header style="height:40px; margin-top:0px; background:white; z-index:99; position:absolute;bottom:auto; top:expression(eval(document.documentElement.scrollTop));">
		<div style="margin-top:10px;">
			<a href="javascript:;" class="easyui-linkbutton" data-options="plain:true" style="width: 80px;margin-left: 5px;color: #3d76b9;" onclick="$('#JZDlgMod').dialog('open')">待接诊(1)</a>&nbsp;|
			...
			<a href="javascript:;" class="easyui-linkbutton" data-options="plain:true" onclick="backPatient();" style="width: 80px;margin-left: 5px;color: #3d76b9;">取消</a>&nbsp;
		</div>
	</header>
	<div id="JZDlgMod" class="easyui-dialog" title="待接诊病人" style="width:500px;height:350px;"
            data-options="
            	closed:true,
                buttons: [{
                    text:'确定',
            ...
            ">
        <table id="JZListMod" class="easyui-datagrid"
	...
	<table style="margin-top: 55px;">
        ...
        <tr>
            <td style="width:300px; height: 40px" colspan="2">
            <p style="width: 185px; text-align: right;">检查治疗项：<a href="javascript:;" class="easyui-linkbutton" onclick="modZLX();" style="width: 100px; margin-left: 5px;">添加</a> </p>
            <div id = "appendZLX" style="padding-left: 85px;padding-bottom: 5px;">
            </div>
            </td>
        </tr>
        <tr>
            <td style="width:300px;height: 40px" colspan="2">
            <p style="width: 185px; text-align: right;">处方：<a href="javascript:;" class="easyui-linkbutton" onclick="modCF();" style="width: 100px;margin-left: 5px;">添加处方</a></p>
            	<div id = "appendCF" style="padding-left: 85px; padding-bottom: 5px;">
	            </div>
            </td>
        </tr>
        <tr>
            <td style="width:300px;height: 40px" colspan="2">
            <p style="width: 185px; text-align: right;">附加费用：<a href="javascript:;" class="easyui-linkbutton" onclick="modFJFY();" style="width: 100px;margin-left: 5px;">添加</a></p>
	            <div id = "appendFJFY" style="padding-left: 85px; padding-bottom: 5px;">
	            </div>
            </td>
        </tr>
        <tr>
    ...
    <script language="javascript" type="text/javascript">
    	...
    	function modZLX() {
    		var appendHtml = 
				...
				"</div>";
			$("#appendZLX").append(appendHtml);
			$.parser.parse('#appendZLX');
		}
    	...
    	function modFJFY() {
    		var appendHtml = 
    			"<div style=\"margin-top: 5px; \">" +
					...
					"<a href=\"javascript:;\" onclick = \"$(this).parent().remove();\" style=\" color: #3d76b9; margin-left: 5px;\">删除</a>" +
				"</div>";
			$("#appendFJFY").append(appendHtml);
			$.parser.parse('#appendFJFY');
		}
  	</script>
  	
  
    <script id="cfTempl_One" type="text/x-dot-template">
									<tr>
  	...
  	<script id="cfTempl" type="text/x-dot-template">
						<div style="background-color: #eee; margin-top: 5px; padding-left: 5px; padding-right: 5px;">
		            			<table border="0" width="100%" cellspacing="" cellpadding="" align="center" style=" text-align: center; background-color: #eee;">
									...
									<tr height="40px">
										<td colspan="8" style="text-align: left;"><a href="javascript:;" onclick = "modCFOne(this);" style="color: #3d76b9;">添加药品</a></td>
									</tr>
								</table>
		            		</div>
    </script>
    <script type="text/javascript">
		...
		function modCF(){
			...
			var pagefn = doT.template($("#cfTempl").text(), undefined, undefined);
			$("#appendCF").append(pagefn(data));
		}
		
		function modCFOne(table){
			var data = {
					title: "My title",
					name: "11",
					htmlText: "<i>html test</i>"
				};
			var pagefn = doT.template($("#cfTempl_One").text(), undefined, undefined);
		 ...
		 function backPatient() {
			 ...
			 tab.panel('refresh', 'sys/menzhen/menzhen_patient.jsp');
		 }
