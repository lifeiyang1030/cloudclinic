...
<body>
	...
	<div id="tab" class="easyui-tabs" data-options="tabPosition:'left',tabHeight:50, plain:false,narrow:true,border:false"style="width:100%;height: 90%; margin-bottom: -65px">
		<div title="挂号列表"  data-options="href:'sys/guahao/guahao_list.jsp'" style="padding: 10px 10px 65px 10px;" >
		</div>
		<div title="新增挂号"  data-options="href:'sys/guahao/guahao_add.jsp'" style="padding: 0px 10px 65px 10px;" >
		</div>
	</div>
</body>
</html>