...
<head>
	...
	<body>
		...
		<div style="height: 40px;line-height: 40px;">
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true" onclick="submitForm()" style="width: 80px;margin-left: 10px;"><span style="font-size: 22px;">收费</span></a>&nbsp;|
		...
		<script language="javascript" type="text/javascript">
	    	function dsf_tf_back() {
				 ...
				 tab.panel('refresh', 'sys/feiyong/feiyong_dsf.jsp');
			 }
    </script>
	</body>
</html>