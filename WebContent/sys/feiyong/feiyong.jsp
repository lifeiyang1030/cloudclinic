...
<body>
	...
	<div id="tab" class="easyui-tabs" data-options="tabPosition:'left',tabHeight:50, plain:false,narrow:true,border:false"style="width:100%;height: 90%; margin-bottom: -65px">
		<div title="待收费"  data-options="href:'sys/feiyong/feiyong_dsf.jsp'" style="padding: 10px 10px 65px 10px;" >
		</div>
		<div title="待退费"  data-options="href:'sys/feiyong/feiyong_dtf.jsp'" style="padding: 10px 10px 65px 10px;" >
		</div>
		<div title="收费历史"  data-options="href:'sys/feiyong/feiyong_sfls.jsp'" style="padding: 10px 10px 65px 10px;" >
		</div>
		<div title="欠费记录"  data-options="href:'sys/feiyong/feiyong_qfjl.jsp'" style="padding: 10px 10px 65px 10px;" >
		</div>
	</div>
