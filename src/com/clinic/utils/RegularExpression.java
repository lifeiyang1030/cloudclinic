...
/**
 * @description 90%的验证都调用了Regular方法 但是本类也可删除大部分方法 涉及到正则的判断都直接穿参数和正则表达式 但是为了方便业务类调用和有更直观的含义，建议不要这么做 Pattern的matcher已经被同步synchronized 所以 此类的任何使用正则验证的方法都不需要同步
 * @version 20140822
 */
public class RegularExpression {
	 ...
	 * 负整数正则表达式 <=0 ^-[1-9]\d*|0$
	 */
	public static final String NEGTIVE_INTEGER = "^-[1-9]\\d*|0$";
	 ...
	 */
	public static final String NEGTIVE_DOUBLE = "^(-([1-9]\\d*\\.\\d*|0\\.\\d*[1-9]\\d*))|0?\\.0+|0$";
	...
	//
	// DateTime 值类型表示值范围在公元（基督纪元）0001 年 1 月 1 日午夜 12:00:00 到公元 (C.E.) 9999 年 12
	// 月 31 日晚上 11:59:59 之间的日期和时间。
	//
	 ...
	 * 身份证正则表达式
	 */
	public static final String PRCRIDCARD = "((11|12|13|14|15|21|22|23|31|32|33|34|35|36|37|41|42|43|44|45|46|50|51|52|53|54|61|62|63|64|65)[0-9]{4})" + "(([1|2][0-9]{3}[0|1][0-9][0-3][0-9][0-9]{3}"
	...
	/**
	 * @description 判断字段是否为空 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static synchronized boolean isStringNull(String str) throws Exception {
		return null == str || str.trim().length() <= 0 ? true : false;
	}

	/**
	 * @description 判断字段是非空 符合返回ture
	 * @param str
	 * @return boolean
	 */
	 ...
	 * @return String
	 */
	public static String strNullToEmpty(String str) throws Exception {
		return isStringNull(str) ? "" : str;
	}

	/**
	 * @description 字符串null赋值默认值
	 * 
	 * @param str：目标字符串
	 * @param defaut：默认值
	 * @return String
	 */
	public static String strNullToDefault(String str, String defaut) throws Exception {
		return isStringNull(str) ? defaut : str;
	}

	/**
	 * @description 判断字段是否为Email 符合返回ture
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 判断是否为电话号码 符合返回ture
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 判断是否为手机号码 符合返回ture
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 判断是否为IP地址 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isIpAddress(String str) throws Exception {
		return Regular(str, IPADDRESS);
	}

	/**
	 * @description 判断字段是否为数字(必须有小数点才返回true Eg:42.1) 正负整数 正负浮点数 符合返回ture
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 判断字段是否为INTEGER 符合返回ture
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 判断字段是否为正整数正则表达式 >=0 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isPositiveInteger(String str) throws Exception {
		return Regular(str, POSITIVE_INTEGER);
	}

	/**
	 * @description 判断字段是否为负整数正则表达式 <=0 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isNegtiveInteger(String str) throws Exception {
		return Regular(str, NEGTIVE_INTEGER);
	}

	/**
	 * @description 判断字段是否为DOUBLE 符合返回ture
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 判断字段是否为正浮点数(必须有小数点才返回true Eg:42.1)正则表达式 >=0 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isPositiveDouble(String str) throws Exception {
		return Regular(str, POSITIVE_DOUBLE);
	}

	/**
	 * @description 判断字段是否为负浮点数(必须有小数点才返回true Eg:-42.1)正则表达式 <=0 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isNegtiveDouble(String str) throws Exception {
		return Regular(str, NEGTIVE_DOUBLE);
	}

	/**
	 * @description 判断字段是否为日期 符合返回ture
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 验证2010-12-10
	 * @param str
	 * @return
	 */
	public static boolean isDate1(String str) throws Exception {
		return Regular(str, DATE_FORMAT1);
	}

	/**
	 * @description 判断字段是否为年龄 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isAge(String str) throws Exception {
		return Regular(str, AGE);
	}

	/**
	 * @description 判断字段是否超长 字串为空返回fasle, 超过长度{leng}返回ture 反之返回false
	 * @param str
	 * @param leng
	 * @return boolean
	 */
	public static boolean isLengOut(String str, int leng) throws Exception {
		return isStringNull(str) ? false : str.trim().length() > leng;
	}

	/**
	 * @description 判断字段是否为身份证 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isPRCRIDCard(String str) throws Exception {
		if (isStringNull(str))
			return false;
		if (str.trim().length() == 15 || str.trim().length() == 18) {
			//return PRCResidentIdentityCard.validatePRCRIDCard(str);
			return Regular(str,PRCRIDCARD);
		} else {
			return false;
		}
	}
	...
	/**
	 * @description 判断字段是否为邮编 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static boolean isPostalCode(String str) throws Exception {
		return Regular(str, POSTAL_CODE);
	}

	/**
	 * @description 判断字符串是不是全部是汉字
	 * @param str
	 * @return boolean
	 */
	public static boolean isChina(String str) throws Exception {
		return Regular(str, STR_CHINA);
	}

	/**
	 * @description 判断字符串是不是全部是英文字母
	 * @param str
	 * @return boolean
	 */
	public static boolean isEnglish(String str) throws Exception {
		return Regular(str, STR_ENG);
	}

	/**
	 * @description 判断字符串是不是全部是英文字母+数字
	 * @param str
	 * @return boolean
	 */
	public static boolean isEnAndNum(String str) throws Exception {
		return Regular(str, STR_ENG_NUM);
	}

	/**
	 * @description 判断字符串是不是全部是英文字母+数字+下划线
	 * @param str
	 * @return boolean
	 */
	public static boolean isEnAndNumAnd_(String str) throws Exception {
		return Regular(str, STR_ENG_NUM_);
	}

	/**
	 * @description 判断字符串是不是全部是数字 不能包含小数点和下划线 匹配返回true
	 * @param str
	 * @return boolean
	 */
	...
	/**
	 * @description 过滤特殊字符串 返回过滤后的字符串
	 * @param str
	 * @return boolean
	 */
	public static String filterSpecialStr(String str) throws Exception {
	...
	/**
	 * @description 判断是不是科学计数法 如果是 返回true 匹配科学计数 e或者E必须出现有且只有一次 结尾不含D 匹配模式可参考本类定义的
	 ...
	 * @return boolean
	 */
	public static boolean isScientific(String str) throws Exception {
		if (isStringNull(str)) {
			return false;
		}
		return Regular(str, RegularExpression.SCIENTIFIC_A);
	}

	/**
	 * @description 匹配是否符合正则表达式pattern 匹配返回true
	 * @param str:需要验证的字符串
	 * @param pattern:正则表达式
	 * @return boolean
	 */
	private static boolean Regular(String str, String pattern) throws Exception {
